...
### 8.6 Redirect authenticated users and protect pages

Go to the home page of you app and log in the user you have in your database.

Go back to the home page of your app.

1. Does it make sense the show the logged in user the link to the `signup` page ?

2. Does it make sense the show the logged in user the link to the `login` page ?
...
Define a `load` function for the `signup` page.

Similar like you did for the `login` page, take care of redirecting the user to the correct page given their session status.
...
Everything together your `+page.server.ts` file for the `signup` page now has this code.
